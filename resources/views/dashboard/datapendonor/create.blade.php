...
<div class="col-lg-8">
    <form method="post" action="/dashboard/donors" class="mb-5">
        @csrf
        <input type="hidden" value="Offline" name="pendaftaran">
      <div class="mb-3">
      ...
      <div class="mb-5">
        ...
        <select class="form-select" name="macamdonor">
      ...
      <div class="mb-3">
        ...
        <select class="form-select" name="tempatdonor">
          <option value="PMI" selected>Kantor UDD PMI</option>
          <option value="Mobile unit">Mobile Unit</option>
        </select>
      </div>

      <h3>Harap Isi Dengan Jujur Untuk Kenyamanan Bersama</h3>
      {{-- 1 --}}
      <div class="mb-3">
