...
<div class="col-lg-8">
    <form method="post" action="/dashboard/posts/{{ $post->slug }}" class="mb-5" enctype="multipart/form-data">
      ...
      <div class="mb-3">
        ...
        @if($post->image)
        <img src="{{ asset('storage/' . $post->image) }}" class="img-priview img-fuid mb-3 col-sm-5 d-block">
        @else
        <img  class="img-priview img-fuid mb-3 col-sm-5">
        @endif
      ...
      <button type="submit" class="btn btn-primary">Ubah Pos</button>
    </form>
